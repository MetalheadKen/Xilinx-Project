...
#  Module Name:         make_pz_fmc2_ali3_amp10.tcl
...
set argv [list board=PZ7015_FMC2 project=pz_fmc2_ali3_amp10 sdk=yes version_override=yes]
set argc [llength $argv]
source ./make.tcl -notrace

# Build Zed Display Kit reference design
# for PicoZed FMC Carrier 2 + PicoZed 7020 SOM
set argv [list board=PZ7020_FMC2 project=pz_fmc2_ali3_amp10 sdk=yes version_override=yes]
set argc [llength $argv]
source ./make.tcl -notrace

# Build Zed Display Kit reference design
# for PicoZed FMC Carrier 2 + PicoZed 7030 SOM
set argv [list board=PZ7030_FMC2 project=pz_fmc2_ali3_amp10 sdk=yes version_override=yes]
set argc [llength $argv]
source ./make.tcl -notrace
