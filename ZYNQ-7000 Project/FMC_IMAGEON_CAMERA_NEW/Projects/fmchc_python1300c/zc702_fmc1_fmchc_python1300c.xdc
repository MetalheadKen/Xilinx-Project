...
set_property PACKAGE_PIN N15  [get_ports fmc_hdmi_cam_iic_scl_io]
...
set_property PACKAGE_PIN P15  [get_ports fmc_hdmi_cam_iic_sda_io]
...
set_property PACKAGE_PIN M19  [get_ports IO_HDMII_clk]
set_property PACKAGE_PIN C22  [get_ports {IO_HDMII_data[0]}]
set_property PACKAGE_PIN D22  [get_ports {IO_HDMII_data[1]}] 
set_property PACKAGE_PIN B17  [get_ports {IO_HDMII_data[2]}]
set_property PACKAGE_PIN C18  [get_ports {IO_HDMII_data[3]}]
set_property PACKAGE_PIN E18  [get_ports {IO_HDMII_data[4]}]
set_property PACKAGE_PIN B16  [get_ports {IO_HDMII_data[5]}]
set_property PACKAGE_PIN C17  [get_ports {IO_HDMII_data[6]}]
set_property PACKAGE_PIN F18  [get_ports {IO_HDMII_data[7]}]
set_property PACKAGE_PIN B22  [get_ports {IO_HDMII_data[8]}]
set_property PACKAGE_PIN B21  [get_ports {IO_HDMII_data[9]}]
set_property PACKAGE_PIN A19  [get_ports {IO_HDMII_data[10]}]
set_property PACKAGE_PIN A18  [get_ports {IO_HDMII_data[11]}]
set_property PACKAGE_PIN D21  [get_ports {IO_HDMII_data[12]}]
set_property PACKAGE_PIN E21  [get_ports {IO_HDMII_data[13]}]
set_property PACKAGE_PIN A17  [get_ports {IO_HDMII_data[14]}]
set_property PACKAGE_PIN A16  [get_ports {IO_HDMII_data[15]}]
set_property PACKAGE_PIN A22  [get_ports {IO_HDMII_spdif}]
...
set_property PACKAGE_PIN M20  [get_ports IO_HDMIO_clk]
set_property PACKAGE_PIN B15  [get_ports {IO_HDMIO_data[0]}]
set_property PACKAGE_PIN C15  [get_ports {IO_HDMIO_data[1]}]
set_property PACKAGE_PIN F22  [get_ports {IO_HDMIO_data[2]}]
set_property PACKAGE_PIN G16  [get_ports {IO_HDMIO_data[3]}]
set_property PACKAGE_PIN F21  [get_ports {IO_HDMIO_data[4]}]
set_property PACKAGE_PIN F17  [get_ports {IO_HDMIO_data[5]}]
set_property PACKAGE_PIN C20  [get_ports {IO_HDMIO_data[6]}]
set_property PACKAGE_PIN G15  [get_ports {IO_HDMIO_data[7]}]
set_property PACKAGE_PIN G17  [get_ports {IO_HDMIO_data[8]}]
set_property PACKAGE_PIN E20  [get_ports {IO_HDMIO_data[9]}]
set_property PACKAGE_PIN D20  [get_ports {IO_HDMIO_data[10]}]
set_property PACKAGE_PIN B20  [get_ports {IO_HDMIO_data[11]}]
set_property PACKAGE_PIN E19  [get_ports {IO_HDMIO_data[12]}]
...
set_property PACKAGE_PIN A21  [get_ports IO_HDMIO_spdif]
...
set_property PACKAGE_PIN P16  [get_ports IO_PYTHON_CAM_clk_pll]
set_property PACKAGE_PIN L19  [get_ports IO_PYTHON_CAM_reset_n]
set_property PACKAGE_PIN R16  [get_ports {IO_PYTHON_CAM_trigger[2]}]
set_property PACKAGE_PIN J16  [get_ports {IO_PYTHON_CAM_trigger[1]}]
set_property PACKAGE_PIN J17  [get_ports {IO_PYTHON_CAM_trigger[0]}]
set_property PACKAGE_PIN P20  [get_ports {IO_PYTHON_CAM_monitor[0]}]
set_property PACKAGE_PIN P21  [get_ports {IO_PYTHON_CAM_monitor[1]}]
set_property PACKAGE_PIN N22  [get_ports IO_PYTHON_SPI_spi_sclk]
set_property PACKAGE_PIN P22  [get_ports IO_PYTHON_SPI_spi_ssel_n]
set_property PACKAGE_PIN R20  [get_ports IO_PYTHON_SPI_spi_mosi]
set_property PACKAGE_PIN R21  [get_ports IO_PYTHON_SPI_spi_miso]
set_property PACKAGE_PIN K19  [get_ports IO_PYTHON_CAM_clk_out_p]; #CAM_CLK_P
set_property PACKAGE_PIN K20  [get_ports IO_PYTHON_CAM_clk_out_n]; #CAM_CLK_N
set_property PACKAGE_PIN L17  [get_ports IO_PYTHON_CAM_sync_p]; #CAM_SYNC_P
set_property PACKAGE_PIN M17  [get_ports IO_PYTHON_CAM_sync_n]; #CAM_SYNC_N
#set_property PACKAGE_PIN M15  [get_ports {IO_PYTHON_CAM_data_p[]}]; #CAM_DATA7_P
#set_property PACKAGE_PIN M16  [get_ports {IO_PYTHON_CAM_data_n[]}]; #CAM_DATA7_N
...
set_property PACKAGE_PIN J15  [get_ports {IO_PYTHON_CAM_data_p[3]}]; #CAM_DATA5_P
set_property PACKAGE_PIN K15  [get_ports {IO_PYTHON_CAM_data_n[3]}]; #CAM_DATA5_N
set_property PACKAGE_PIN N17  [get_ports {IO_PYTHON_CAM_data_p[2]}]; #CAM_DATA4_P
set_property PACKAGE_PIN N18  [get_ports {IO_PYTHON_CAM_data_n[2]}]; #CAM_DATA4_N
...
set_property PACKAGE_PIN J18  [get_ports {IO_PYTHON_CAM_data_p[0]}]; #CAM_DATA2_P
set_property PACKAGE_PIN K18  [get_ports {IO_PYTHON_CAM_data_n[0]}]; #CAM_DATA2_N
#set_property PACKAGE_PIN J20  [get_ports {IO_PYTHON_CAM_data_p[]}]; #CAM_DATA1_P
#set_property PACKAGE_PIN K21  [get_ports {IO_PYTHON_CAM_data_n[]}]; #CAM_DATA1_N
#set_property PACKAGE_PIN L21  [get_ports {IO_PYTHON_CAM_data_p[]}]; #CAM_DATA0_P
#set_property PACKAGE_PIN L22  [get_ports {IO_PYTHON_CAM_data_n[]}]; #CAM_DATA0_N
