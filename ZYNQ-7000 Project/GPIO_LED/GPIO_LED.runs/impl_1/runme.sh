...
HD_PWD='D:/Xilinx_Project/GPIO_LED/GPIO_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_led_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_led_wrapper.tcl -notrace
