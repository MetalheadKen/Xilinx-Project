...
HD_PWD='D:/Xilinx_Project/GPIO_LED/GPIO_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_led_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_led_wrapper.tcl
