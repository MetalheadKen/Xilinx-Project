...
HD_PWD='D:/Xilinx_Project/GPIO_LED/GPIO_LED.runs/design_led_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_led_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_led_axi_gpio_0_0.tcl
