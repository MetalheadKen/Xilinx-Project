...
HD_PWD='D:/Xilinx_Project/LED_8bits/LED_8bits.runs/led_8bits_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_8bits_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_8bits_processing_system7_0_0.tcl
