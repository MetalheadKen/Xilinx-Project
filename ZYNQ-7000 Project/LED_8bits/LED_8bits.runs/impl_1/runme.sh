...
HD_PWD='D:/Xilinx_Project/LED_8bits/LED_8bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_8bits_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_8bits_wrapper.tcl -notrace
