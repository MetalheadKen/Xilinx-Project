...
create_clock -period 5.000 -name clk_fpga_2 [get_nets -hierarchical FCLK_CLK2]
create_clock -period 6.730 -name fmc1_vita_clk [get_ports fmc_imageon_vclk_r]
create_clock -period 2.692 -name fmc1_vita_ser_clk [get_ports IO_VITA_CAM_R_clk_out_p]
create_clock -period 6.730 -name fmc2_vita_clk [get_ports fmc_imageon_vclk_l]
create_clock -period 2.692 -name fmc2_vita_ser_clk [get_ports IO_VITA_CAM_L_clk_out_p]

# Define asynchronous clock domains
##set_clock_groups -asynchronous -group [get_clocks clk_fpga_0] -group [get_clocks clk_fpga_1] -group [get_clocks video_clk_r] -group [get_clocks video_clk_l] -group [get_clocks CLKDIV_c_0] -group [get_clocks vita_clk_div4_l_n_0]
