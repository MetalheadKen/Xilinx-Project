...
#set_property PACKAGE_PIN L21 [get_ports {vita_io_data_p[5]}];
#set_property PACKAGE_PIN L22 [get_ports {vita_io_data_n[5]}];
#set_property PACKAGE_PIN N22 [get_ports {vita_io_data_p[6]}];
#set_property PACKAGE_PIN P22 [get_ports {vita_io_data_n[6]}];
#set_property PACKAGE_PIN P17 [get_ports {vita_io_data_p[7]}];
#set_property PACKAGE_PIN P18 [get_ports {vita_io_data_n[7]}];
