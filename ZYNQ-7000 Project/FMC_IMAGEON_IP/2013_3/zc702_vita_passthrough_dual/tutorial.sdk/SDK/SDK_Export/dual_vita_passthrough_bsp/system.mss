...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = fmc1_imageon_hdmio_rgb_v_tc_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 2.08.a
 PARAMETER HW_INSTANCE = fmc1_imageon_iic
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = cfa
 PARAMETER DRIVER_VER = 5.00.a
 PARAMETER HW_INSTANCE = fmc1_imageon_vita_color_v_cfa_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = dpc
 PARAMETER DRIVER_VER = 5.00.a
 PARAMETER HW_INSTANCE = fmc1_imageon_vita_color_v_spc_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 4.00.a
 PARAMETER HW_INSTANCE = fmc2_imageon_hdmio_rgb_v_tc_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 2.08.a
 PARAMETER HW_INSTANCE = fmc2_imageon_iic
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = cfa
 PARAMETER DRIVER_VER = 5.00.a
 PARAMETER HW_INSTANCE = fmc2_imageon_vita_color_v_cfa_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = dpc
 PARAMETER DRIVER_VER = 5.00.a
 PARAMETER HW_INSTANCE = fmc2_imageon_vita_color_v_spc_0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = fmc1_imageon_vita_color_fmc_imageon_vita_receiver_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = fmc_imageon_vita_receiver
 PARAMETER DRIVER_VER = 2.01.a
 PARAMETER HW_INSTANCE = fmc2_imageon_vita_color_fmc_imageon_vita_receiver_0
END
