# Hierarchical cell: fmc_imageon_vita_mono
proc create_hier_cell_fmc_imageon_vita_mono { parentCell nameHier } {

  if { $parentCell eq "" || $nameHier eq "" } {
     puts "ERROR: create_hier_cell_fmc_imageon_vita_mono() - Empty argument(s)!"
     return
  }
  ...
  connect_bd_intf_net -intf_net v_spc_0_video_out [get_bd_intf_pins vita_axi4s_video] [get_bd_intf_pins v_spc_0/video_out]
  ...
  connect_bd_net -net clk_fpga_0 [get_bd_pins axi4lite_clk] [get_bd_pins fmc_imageon_vita_receiver_0/s00_axi_aclk] [get_bd_pins v_spc_0/s_axi_aclk]
  connect_bd_net -net clk_fpga_1 [get_bd_pins clk200] [get_bd_pins fmc_imageon_vita_receiver_0/clk200]
  connect_bd_net -net clk_fpga_2 [get_bd_pins axi4s_clk] [get_bd_pins v_spc_0/aclk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  ...
  connect_bd_net -net proc_sys_reset_peripheral_aresetn [get_bd_pins axi4lite_aresetn] [get_bd_pins fmc_imageon_vita_receiver_0/s00_axi_aresetn] [get_bd_pins v_spc_0/s_axi_aresetn]
  connect_bd_net -net vcc_const [get_bd_pins fmc_imageon_vita_receiver_0/oe] [get_bd_pins v_spc_0/aclken] [get_bd_pins v_spc_0/aresetn] [get_bd_pins v_spc_0/s_axi_aclken] [get_bd_pins v_vid_in_axi4s_0/aclken] [get_bd_pins v_vid_in_axi4s_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/axis_enable] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce] [get_bd_pins vcc/const]
...
# Create instance: fmc_imageon_vita_mono
create_hier_cell_fmc_imageon_vita_mono [current_bd_instance .] fmc_imageon_vita_mono