...
# Hierarchical cell: fmc_imageon_hdmio_y
proc create_hier_cell_fmc_imageon_hdmio_y { parentCell nameHier } {

  if { $parentCell eq "" || $nameHier eq "" } {
     puts "ERROR: create_hier_cell_fmc_imageon_hdmio_y() - Empty argument(s)!"
     return
  }
  ...
  # Create instance: y_to_yuv422, and set properties
  set y_to_yuv422 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_subset_converter:1.1 y_to_yuv422 ]
  set_property -dict [ list CONFIG.M_TDATA_NUM_BYTES {2} CONFIG.TDATA_REMAP {8'b10000000,tdata[7:0]}  ] $y_to_yuv422

  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins vtc_ctrl] [get_bd_intf_pins v_tc_0/ctrl]
  connect_bd_intf_net -intf_net axis_subset_converter_0_m_axis [get_bd_intf_pins v_axi4s_vid_out_0/video_in] [get_bd_intf_pins y_to_yuv422/M_AXIS]
  ...
  connect_bd_intf_net -intf_net hdmio_axi4s_video_1 [get_bd_intf_pins hdmio_axi4s_video] [get_bd_intf_pins y_to_yuv422/S_AXIS]
  ...
  connect_bd_net -net axi4s_clk_1 [get_bd_pins axi4s_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins y_to_yuv422/aclk]
  ...
  connect_bd_net -net vcc_const [get_bd_pins fmc_imageon_hdmi_out_0/embed_syncs] [get_bd_pins fmc_imageon_hdmi_out_0/oe] [get_bd_pins v_axi4s_vid_out_0/aclken] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_ce] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/det_clken] [get_bd_pins v_tc_0/s_axi_aclken] [get_bd_pins vcc/const] [get_bd_pins y_to_yuv422/aresetn]
...
# Create instance: fmc_imageon_hdmio_y
create_hier_cell_fmc_imageon_hdmio_y [current_bd_instance .] fmc_imageon_hdmio_y