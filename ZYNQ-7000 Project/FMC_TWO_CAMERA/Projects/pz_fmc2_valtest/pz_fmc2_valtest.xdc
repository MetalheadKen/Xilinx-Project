...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN V14  [get_ports {mac_id_tri_io          }];  # "V14.BANK13_LVDS_12_N.JX3.88.MAC_ID"

# ----------------------------------------------------------------------------
# I2C Peripherals - RTC, EEPROM, Clock Generator, HDMI Output - Bank 35
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN H6   [get_ports {hdmi_scl_io       }];  # "H6.JX1_SE_0.JX1.9.HDMIO_SCL"
set_property PACKAGE_PIN H5   [get_ports {hdmi_sda_io       }];  # "H5.JX1_SE_1.JX1.10.HDMIO_SDA"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN C4   [get_ports {gpio_tri_io[0]       }];  # "C4.JX1_LVDS_11_N.JX1.44.CLK0_M2C_N"
set_property PACKAGE_PIN D5   [get_ports {gpio2_tri_io[0]       }];  # "D5.JX1_LVDS_11_P.JX1.42.CLK0_M2C_P"
set_property PACKAGE_PIN B8   [get_ports {fmc_scl_io         }];  # "B8.JX1_LVDS_23_N.JX1.84.FMC_SCL"
set_property PACKAGE_PIN C8   [get_ports {fmc_sda_io         }];  # "C8.JX1_LVDS_23_P.JX1.82.FMC_SDA"
set_property PACKAGE_PIN B3   [get_ports {gpio_tri_io[1]        }];  # "B3.JX1_LVDS_12_N.JX1.49.LA00_CC_N"
set_property PACKAGE_PIN B4   [get_ports {gpio2_tri_io[1]       }];  # "B4.JX1_LVDS_12_P.JX1.47.LA00_CC_P"
set_property PACKAGE_PIN C3   [get_ports {gpio_tri_io[2]        }];  # "C3.JX1_LVDS_13_N.JX1.50.LA01_CC_N"
set_property PACKAGE_PIN D3   [get_ports {gpio2_tri_io[2]       }];  # "D3.JX1_LVDS_13_P.JX1.48.LA01_CC_P"
set_property PACKAGE_PIN E3   [get_ports {gpio_tri_io[3]           }];  # "E3.JX1_LVDS_5_N.JX1.26.LA02_N"
set_property PACKAGE_PIN E4   [get_ports {gpio2_tri_io[3]          }];  # "E4.JX1_LVDS_5_P.JX1.24.LA02_P"
set_property PACKAGE_PIN F6   [get_ports {gpio_tri_io[4]           }];  # "F6.JX1_LVDS_6_N.JX1.31.LA03_N"
set_property PACKAGE_PIN G6   [get_ports {gpio2_tri_io[4]          }];  # "G6.JX1_LVDS_6_P.JX1.29.LA03_P"
set_property PACKAGE_PIN B1   [get_ports {gpio_tri_io[5]           }];  # "B1.JX1_LVDS_7_N.JX1.32.LA04_N"
set_property PACKAGE_PIN B2   [get_ports {gpio2_tri_io[5]          }];  # "B2.JX1_LVDS_7_P.JX1.30.LA04_P"
set_property PACKAGE_PIN D8   [get_ports {gpio_tri_io[6]           }];  # "D8.JX1_LVDS_8_N.JX1.37.LA05_N"
set_property PACKAGE_PIN E8   [get_ports {gpio2_tri_io[6]          }];  # "E8.JX1_LVDS_8_P.JX1.35.LA05_P"
set_property PACKAGE_PIN G1   [get_ports {gpio_tri_io[7]           }];  # "G1.JX1_LVDS_9_N.JX1.38.LA06_N"
set_property PACKAGE_PIN H1   [get_ports {gpio2_tri_io[7]          }];  # "H1.JX1_LVDS_9_P.JX1.36.LA06_P"
set_property PACKAGE_PIN C5   [get_ports {gpio_tri_io[8]           }];  # "C5.JX1_LVDS_10_N.JX1.43.LA07_N"
set_property PACKAGE_PIN C6   [get_ports {gpio2_tri_io[8]          }];  # "C6.JX1_LVDS_10_P.JX1.41.LA07_P"
set_property PACKAGE_PIN C1   [get_ports {gpio_tri_io[9]           }];  # "C1.JX1_LVDS_14_N.JX1.55.LA08_N"
set_property PACKAGE_PIN D1   [get_ports {gpio2_tri_io[9]          }];  # "D1.JX1_LVDS_14_P.JX1.53.LA08_P"
set_property PACKAGE_PIN A1   [get_ports {gpio_tri_io[10]           }];  # "A1.JX1_LVDS_15_N.JX1.56.LA09_N"
set_property PACKAGE_PIN A2   [get_ports {gpio2_tri_io[10]          }];  # "A2.JX1_LVDS_15_P.JX1.54.LA09_P"
set_property PACKAGE_PIN D2   [get_ports {gpio_tri_io[11]          }];  # "D2.JX1_LVDS_16_N.JX1.63.LA10_N"
set_property PACKAGE_PIN E2   [get_ports {gpio2_tri_io[11]          }];  # "E2.JX1_LVDS_16_P.JX1.61.LA10_P"
set_property PACKAGE_PIN D6   [get_ports {gpio_tri_io[12]           }];  # "D6.JX1_LVDS_17_N.JX1.64.LA11_N"
set_property PACKAGE_PIN D7   [get_ports {gpio2_tri_io[12]          }];  # "D7.JX1_LVDS_17_P.JX1.62.LA11_P"
set_property PACKAGE_PIN E7   [get_ports {gpio_tri_io[13]           }];  # "E7.JX1_LVDS_18_N.JX1.69.LA12_N"
set_property PACKAGE_PIN F7   [get_ports {gpio2_tri_io[13]          }];  # "F7.JX1_LVDS_18_P.JX1.67.LA12_P"
set_property PACKAGE_PIN A4   [get_ports {gpio_tri_io[14]           }];  # "A4.JX1_LVDS_19_N.JX1.70.LA13_N"
set_property PACKAGE_PIN A5   [get_ports {gpio2_tri_io[14]          }];  # "A5.JX1_LVDS_19_P.JX1.68.LA13_P"
set_property PACKAGE_PIN G7   [get_ports {gpio_tri_io[15]           }];  # "G7.JX1_LVDS_20_N.JX1.75.LA14_N"
set_property PACKAGE_PIN G8   [get_ports {gpio2_tri_io[15]          }];  # "G8.JX1_LVDS_20_P.JX1.73.LA14_P"
set_property PACKAGE_PIN A6   [get_ports {gpio_tri_io[16]           }];  # "A6.JX1_LVDS_21_N.JX1.76.LA15_N"
set_property PACKAGE_PIN A7   [get_ports {gpio2_tri_io[16]          }];  # "A7.JX1_LVDS_21_P.JX1.74.LA15_P"
set_property PACKAGE_PIN B6   [get_ports {gpio_tri_io[17]           }];  # "B6.JX1_LVDS_22_N.JX1.83.LA16_N"
set_property PACKAGE_PIN B7   [get_ports {gpio2_tri_io[17]          }];  # "B7.JX1_LVDS_22_P.JX1.81.LA16_P"

# ----------------------------------------------------------------------------
# FMC Expansion Connector - Bank 34 / JX2
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN L4   [get_ports {gpio_1_tri_io[0]      }];  # "L4.JX2_LVDS_11_N.JX2.50.CLK1_M2C_N"
set_property PACKAGE_PIN L5   [get_ports {gpio2_1_tri_io[0]      }];  # "L5.JX2_LVDS_11_P.JX2.48.CLK1_M2C_P"
#set_property PACKAGE_PIN L7   [get_ports {FMC_PRSNT_N     }];  # "L7.JX2_LVDS_2_N.JX2.25.FMC_PRSNT_N"
set_property PACKAGE_PIN T1   [get_ports {gpio_1_tri_io[1]       }];  # "T1.JX2_LVDS_12_N.JX2.55.LA17_CC_N"
set_property PACKAGE_PIN T2   [get_ports {gpio2_1_tri_io[1]       }];  # "T2.JX2_LVDS_12_P.JX2.53.LA17_CC_P"
set_property PACKAGE_PIN U1   [get_ports {gpio_1_tri_io[2]       }];  # "U1.JX2_LVDS_13_N.JX2.56.LA18_CC_N"
set_property PACKAGE_PIN U2   [get_ports {gpio2_1_tri_io[2]       }];  # "U2.JX2_LVDS_13_P.JX2.54.LA18_CC_P"
set_property PACKAGE_PIN J1   [get_ports {gpio_1_tri_io[3]          }];  # "J1.JX2_LVDS_1_N.JX2.20.LA19_N"
set_property PACKAGE_PIN J2   [get_ports {gpio2_1_tri_io[3]          }];  # "J2.JX2_LVDS_1_P.JX2.18.LA19_P"
set_property PACKAGE_PIN K2   [get_ports {gpio_1_tri_io[4]          }];  # "K2.JX2_LVDS_3_N.JX2.26.LA20_N"
set_property PACKAGE_PIN J3   [get_ports {gpio2_1_tri_io[4]          }];  # "J3.JX2_LVDS_3_P.JX2.24.LA20_P"
set_property PACKAGE_PIN R7   [get_ports {gpio_1_tri_io[5]          }];  # "R7.JX2_LVDS_4_N.JX2.31.LA21_N"
set_property PACKAGE_PIN P7   [get_ports {gpio2_1_tri_io[5]          }];  # "P7.JX2_LVDS_4_P.JX2.29.LA21_P"
set_property PACKAGE_PIN L1   [get_ports {gpio_1_tri_io[6]          }];  # "L1.JX2_LVDS_5_N.JX2.32.LA22_N"
set_property PACKAGE_PIN L2   [get_ports {gpio2_1_tri_io[6]          }];  # "L2.JX2_LVDS_5_P.JX2.30.LA22_P"
set_property PACKAGE_PIN N3   [get_ports {gpio_1_tri_io[7]          }];  # "N3.JX2_LVDS_6_N.JX2.37.LA23_N"
set_property PACKAGE_PIN N4   [get_ports {gpio2_1_tri_io[7]          }];  # "N4.JX2_LVDS_6_P.JX2.35.LA23_P"
set_property PACKAGE_PIN P2   [get_ports {gpio_1_tri_io[8]          }];  # "P2.JX2_LVDS_7_N.JX2.38.LA24_N"
set_property PACKAGE_PIN P3   [get_ports {gpio2_1_tri_io[8]          }];  # "P3.JX2_LVDS_7_P.JX2.36.LA24_P"
set_property PACKAGE_PIN M1   [get_ports {gpio_1_tri_io[9]          }];  # "M1.JX2_LVDS_8_N.JX2.43.LA25_N"
set_property PACKAGE_PIN M2   [get_ports {gpio2_1_tri_io[9]          }];  # "M2.JX2_LVDS_8_P.JX2.41.LA25_P"
set_property PACKAGE_PIN P1   [get_ports {gpio_1_tri_io[10]          }];  # "P1.JX2_LVDS_9_N.JX2.44.LA26_N"
set_property PACKAGE_PIN N1   [get_ports {gpio2_1_tri_io[10]          }];  # "N1.JX2_LVDS_9_P.JX2.42.LA26_P"
set_property PACKAGE_PIN R2   [get_ports {gpio_1_tri_io[11]          }];  # "R2.JX2_LVDS_14_N.JX2.63.LA27_N"
set_property PACKAGE_PIN R3   [get_ports {gpio2_1_tri_io[11]          }];  # "R3.JX2_LVDS_14_P.JX2.61.LA27_P"
set_property PACKAGE_PIN M6   [get_ports {gpio_1_tri_io[12]          }];  # "M6.JX2_LVDS_15_N.JX2.64.LA28_N"
set_property PACKAGE_PIN L6   [get_ports {gpio2_1_tri_io[12]          }];  # "L6.JX2_LVDS_15_P.JX2.62.LA28_P"
set_property PACKAGE_PIN R4   [get_ports {gpio_1_tri_io[13]          }];  # "R4.JX2_LVDS_17_N.JX2.70.LA29_N"
set_property PACKAGE_PIN R5   [get_ports {gpio2_1_tri_io[13]          }];  # "R5.JX2_LVDS_17_P.JX2.68.LA29_P"
set_property PACKAGE_PIN J6   [get_ports {gpio_1_tri_io[14]          }];  # "J6.JX2_LVDS_18_N.JX2.75.LA30_N"
set_property PACKAGE_PIN J7   [get_ports {gpio2_1_tri_io[14]          }];  # "J7.JX2_LVDS_18_P.JX2.73.LA30_P"
set_property PACKAGE_PIN P5   [get_ports {gpio_1_tri_io[15]          }];  # "P5.JX2_LVDS_19_N.JX2.76.LA31_N"
set_property PACKAGE_PIN P6   [get_ports {gpio2_1_tri_io[15]          }];  # "P6.JX2_LVDS_19_P.JX2.74.LA31_P"
set_property PACKAGE_PIN K8   [get_ports {gpio_1_tri_io[16]          }];  # "K8.JX2_LVDS_20_N.JX2.83.LA32_N"
set_property PACKAGE_PIN J8   [get_ports {gpio2_1_tri_io[16]          }];  # "J8.JX2_LVDS_20_P.JX2.81.LA32_P"
set_property PACKAGE_PIN N5   [get_ports {gpio_1_tri_io[17]          }];  # "N5.JX2_LVDS_21_N.JX2.84.LA33_N"
set_property PACKAGE_PIN N6   [get_ports {gpio2_1_tri_io[17]          }];  # "N6.JX2_LVDS_21_P.JX2.82.LA33_P"
