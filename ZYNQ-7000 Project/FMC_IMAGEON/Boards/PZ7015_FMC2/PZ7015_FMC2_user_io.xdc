...
#  Module Name:         PZ7015_FMC2_user_io.xdc
...
set_property PACKAGE_PIN G2   [get_ports {emio_user_tri_io[4]}];  # "PL_PB1"
set_property PACKAGE_PIN T16  [get_ports {emio_user_tri_io[5]}];  # "PL_PB2"
set_property PACKAGE_PIN AB22 [get_ports {emio_user_tri_io[6]}];  # "PL_PB3"
set_property PACKAGE_PIN AB18 [get_ports {emio_user_tri_io[7]}];  # "PL_PB4"
set_property PACKAGE_PIN AB19 [get_ports {emio_user_tri_io[8]}];  # "PL_PB5"
