...
#  Project Name:        
#  Target Devices:      
#  Hardware Boards:     FMC-IMAGEON + VITA-2000-C
# 
#  Tool versions:       Vivado 2015.2
# 
#  Description:         SDK Build Script for FMC-IMAGEON + VITA-2000-C Design
# 
...
#!/usr/bin/tclsh
set project  "fmc_imageon_gs"
set hw_name  "fmc_imageon_gs_hw"
set bsp_name "fmc_imageon_gs_bsp"
set app_name "fmc_imageon_gs_app"
...
# Create fmcimageon_gs application
puts "\n#\n#\n# Creating ${app_name} ...\n#\n#\n"
...
# Modify fmcimageon_gs BSP (with HSI commands)
puts "\n#\n#\n# Creating ${bsp_name} ...\n#\n#\n"
#
...
# Add FMC_IMAGEON_SW library
hsi::add_library fmc_iic_sw
hsi::add_library fmc_imageon_sw
# Add ONSEMI_VITA_SW library
hsi::add_library onsemi_vita_sw
# Build BSP
