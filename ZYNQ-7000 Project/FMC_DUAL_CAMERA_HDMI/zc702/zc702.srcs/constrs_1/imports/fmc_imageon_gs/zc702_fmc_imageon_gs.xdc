...
create_clock -period 6.730 -name fmc_imageon_vclk_l [get_ports fmc_imageon_vclk_l]
create_clock -period 2.692 -name fmc_vita_ser_clk_l [get_ports IO_VITA_CAM_L_clk_out_p]
create_clock -period 6.730 -name fmc_imageon_vclk_r [get_ports fmc_imageon_vclk_r]
create_clock -period 2.692 -name fmc_vita_ser_clk_r [get_ports IO_VITA_CAM_R_clk_out_p]
