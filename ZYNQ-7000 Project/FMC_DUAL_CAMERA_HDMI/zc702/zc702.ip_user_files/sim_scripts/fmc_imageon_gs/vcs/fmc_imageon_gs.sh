...
reset_run()
{
  files_to_remove=(ucli.key fmc_imageon_gs_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc fmc_imageon_gs_simv.daidir)
...
compile()
{
  ...
  vhdlan -work v_cfa_v7_0_7 $opts_vhd \
...
elaborate()
{
  opts="-load "E:/Xilinx/Vivado/2015.4/lib/win64.o/libxil_vcs.dll:xilinx_register_systf" -full64 -debug_pp -t ps -licqueue -l elaborate.log"

  vcs $opts xil_defaultlib.fmc_imageon_gs xil_defaultlib.glbl -o fmc_imageon_gs_simv
}
...
simulate()
{
  ...
  ./fmc_imageon_gs_simv $opts -do simulate.do
}
# Script usage
usage()
{
