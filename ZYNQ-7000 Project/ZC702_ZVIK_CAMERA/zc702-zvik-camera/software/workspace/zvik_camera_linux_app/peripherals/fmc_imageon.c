...
//                      Nov 28, 2012: 1.07 Configure ADV7611 LLC for inverse polarity
...
*
******************************************************************************/
int fmc_imageon_hdmii_init2( fmc_imageon_t *pContext, Xuint32 Enable, Xuint32 edidInit, Xuint8 pEdid[256], Xuint32 llc_polarity, Xuint32 llc_delay )
{
   ...
   fmc_imageon_hdmii_init( pContext, Enable, edidInit, pEdid );
}
