...
HD_PWD='D:/Xilinx_Project/FMC_IMAGEON/Projects/fmc_imageon_gs/ZC702/fmc_imageon_gs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fmc_imageon_gs_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fmc_imageon_gs_wrapper.tcl
