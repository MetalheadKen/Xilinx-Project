...
HD_PWD='D:/Xilinx_Project/FMC_IMAGEON/Projects/fmc_imageon_gs/ZC702/fmc_imageon_gs.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fmc_imageon_gs_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source fmc_imageon_gs_wrapper.tcl -notrace
