...
HD_PWD='D:/Xilinx_Project/SD_CARD_ReadWrite/SD_CARD_ReadWrite/SD_CARD_ReadWrite.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_sdcard_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source design_sdcard_wrapper.tcl
