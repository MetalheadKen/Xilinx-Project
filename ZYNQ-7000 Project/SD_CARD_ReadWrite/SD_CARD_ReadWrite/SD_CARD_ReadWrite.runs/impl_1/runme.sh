...
HD_PWD='D:/Xilinx_Project/SD_CARD_ReadWrite/SD_CARD_ReadWrite/SD_CARD_ReadWrite.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_sdcard_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source design_sdcard_wrapper.tcl -notrace
